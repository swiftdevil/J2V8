...
public class V8TypedArraysTest {
    ...
    public void testInt8Array() {
        V8Value result = (V8Value) v8Context.executeScript("var ints = new Int8Array(); ints");
    ...
    public void testInt16Array() {
        V8Value result = (V8Value) v8Context.executeScript("var ints = new Int16Array(); ints");
    ...
    public void testUint8Array() {
        V8Value result = (V8Value) v8Context.executeScript("var ints = new Uint8Array(); ints");
    ...
    public void testUint16Array() {
        V8Value result = (V8Value) v8Context.executeScript("var ints = new Uint16Array(); ints");
    ...
    public void testInt32Array() {
        V8Value result = (V8Value) v8Context.executeScript("var ints = new Int32Array(); ints");
    ...
    public void testUInt32Array() {
        V8Value result = (V8Value) v8Context.executeScript("var ints = new Uint32Array(); ints");
    ...
    public void testFloat32Array() {
        V8Value result = (V8Value) v8Context.executeScript("var floats = new Float32Array(); floats");
    ...
    public void testFloat64Array() {
        V8Value result = (V8Value) v8Context.executeScript("var floats = new Float64Array(); floats");
    ...
    public void testTypedArrayLength() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(4); var ints = new Int32Array(buf); ints[0] = 7; ints");
    ...
    public void testGetTypedArrayValue() {
        int result = v8Context.executeIntegerScript("var buf = new ArrayBuffer(4); var ints = new Int16Array(buf); ints[0] = 7; ints[0]");
    ...
    public void testGetTypedArrayIntValue() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(4); var ints = new Int16Array(buf); ints[0] = 7; ints");
    ...
    public void testGetTypedArrayIntType() {
        ...
        assertEquals(V8API.INTEGER, result.getType(0));
        result.close();
    }

    @Test
    public void testGetTypedArrayFloatType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(4); var floats = new Float32Array(buf); floats[0] = 7.7; floats");

        assertEquals(V8API.DOUBLE, result.getType(0));
        result.close();
    }
    ...
    public void testGetTypedArrayIntArrayType() {
        ...
        assertEquals(V8API.INT_16_ARRAY, result.getType());
        result.close();
    }
    ...
    public void testGetTypedArrayUInt8Type() {
        v8Context.registerJavaMethod(new JavaVoidCallback() {
            ...
            public void invoke(final V8Object receiver, final V8Array parameters) {
                assertEquals(V8API.V8_TYPED_ARRAY, parameters.getType(0));
            }
        }, "javaMethod");
        v8Context.executeScript("var buf = new ArrayBuffer(4); var ints = new Uint8ClampedArray(buf); ints[0] = 7; javaMethod(ints);");
    }

    @Test
    public void testAccessSignedValueFromUnsignedByte_Greater128() {
        V8TypedArray array = (V8TypedArray) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Uint8ClampedArray(buf); bytes[0] = 240; bytes[1] = 7; bytes");
    ...
    public void testAccessSignedValueFromUnsignedByte_Less128() {
        V8TypedArray array = (V8TypedArray) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Uint8Array(buf); bytes[0] = 20; bytes[1] = 7; bytes");
        V8ArrayBuffer arrayBuffer = array.getBuffer();
    ...
    public void testInt8IsByteArray() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Int8Array(buf); bytes[0] = 1; bytes[1] = 256; bytes");

        assertEquals(V8API.BYTE, result.getType());
        result.close();
    }
    ...
    public void testInt8_GetType() {
        ...
        assertEquals(V8API.INT_8_ARRAY, result.getType());
        result.close();
    }

    @Test
    public void testUint8Clamped_GetType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Uint8ClampedArray(buf); bytes[0] = 1; bytes[1] = 256; bytes");

        assertEquals(V8API.UNSIGNED_INT_8_CLAMPED_ARRAY, result.getType());
        result.close();
    }

    @Test
    public void testUint8Array_GetType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Uint8Array(buf); bytes[0] = 1; bytes[1] = 256; bytes");

        assertEquals(V8API.UNSIGNED_INT_8_ARRAY, result.getType());
        result.close();
    }

    @Test
    public void testInt16Array_GetType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Int16Array(buf); bytes[0] = 1; bytes[1] = 256; bytes");
    ...
    public void testUnsignedInt16Array_GetType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Uint16Array(buf); bytes[0] = 1; bytes[1] = 256; bytes");

        assertEquals(V8API.UNSIGNED_INT_16_ARRAY, result.getType());
        assertEquals(4, result.length());
        result.close();
    }
    ...
    public void testInt32Array_GetType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Int32Array(buf); bytes[0] = 1; bytes[1] = 256; bytes");

        assertEquals(V8API.INT_32_ARRAY, result.getType());
    ...
    public void testUInt32Array_GetType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Uint32Array(buf); bytes[0] = 1; bytes[1] = 256; bytes");

        assertEquals(V8API.UNSIGNED_INT_32_ARRAY, result.getType());
        assertEquals(2, result.length());
        result.close();
    }
    ...
    public void testFloat32Array_GetType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Float32Array(buf); bytes[0] = 1; bytes[1] = 256; bytes");

        assertEquals(V8API.FLOAT_32_ARRAY, result.getType());
        assertEquals(2, result.length());
        result.close();
    }
    ...
    public void testFloat64Array_GetType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var bytes = new Float64Array(buf); bytes[0] = 1; bytes[1] = 256; bytes");

        assertEquals(V8API.FLOAT_64_ARRAY, result.getType());
        assertEquals(1, result.length());
        result.close();
    }
    ...
    public void testGetTypedArrayFloatArrayType() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var floats = new Float32Array(buf); floats[0] = 7.7; floats[1] = 7; floats");
    ...
    public void testGetTypedArrayType32BitValue() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(4); var ints = new Int32Array(buf); ints[0] = 255; ints");
    ...
    public void testGetTypedArrayType16BitValue() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(4); var ints = new Int16Array(buf); ints[0] = 255; ints");
    ...
    public void testGetTypedArrayType32BitFloatValue() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(4); var floats = new Float32Array(buf); floats[0] = 255.5; floats");
    ...
    public void testGetTypedArrayType64BitFloatValue() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var floats = new Float64Array(buf); floats[0] = 255.5; floats");
    ...
    public void testGetTypedRangeArrayValue() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(100); var ints = new Int32Array(buf); for(var i = 0; i < 25; i++) {ints[i] = i;}; ints");
    ...
    public void testGetTypedArrayGetKeys() {
        V8Array result = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var ints = new Int32Array(buf); ints[0] = 255; ints[1] = 17; ints");
    ...
    public void testAddTypedArrayInteger() {
        V8Array array = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var ints = new Int32Array(buf); ints");
    ...
    public void testAddTypedArrayFloat() {
        V8Array array = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var floats = new Float32Array(buf); floats");
    ...
    public void testCannotPushV8ObjectToTypedArray() {
        V8Array array = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var ints = new Int32Array(buf); ints");
        V8Object obj = new V8Object(v8Context);
    ...
    public void testCannotPushV8ArrayToTypedArray() {
        V8Array array = (V8Array) v8Context.executeScript("var buf = new ArrayBuffer(8); var ints = new Int32Array(buf); ints");
        V8Array obj = new V8Array(v8Context);
    ...
    public void testIntArrayLength() {
        v8Context.executeVoidScript("var buf = new ArrayBuffer(100);\n"
                + "var ints = new Int32Array(buf);\n");
        int arrayLength = v8Context.executeIntegerScript("ints.length;"); // 4 bytes for each element
    ...
    public void testIntArrayByteLength() {
        v8Context.executeVoidScript("var buf = new ArrayBuffer(100);\n"
                + "var ints = new Int32Array(buf);\n");
        int arrayLength = v8Context.executeIntegerScript("ints.byteLength;"); // 4 bytes for each element
    ...
    public void testGetTypedArray() {
        ...
        int type = v8Context.getType("intsArray");

        assertEquals(V8API.V8_TYPED_ARRAY, type);
    }
    ...
    public void testGetTypedArray_IntegerType() {
        ...
        V8Array intsArray = (V8Array) v8Context.get("intsArray");

        assertEquals(V8API.INTEGER, intsArray.getType());
        intsArray.close();
    }

    @Test
    public void testGetTypedArray_DoubleType() {
        v8Context.executeVoidScript("var buf = new ArrayBuffer(80);\n"
                + "var doublesArray = new Float64Array(buf);");

        V8Array doublesArray = (V8Array) v8Context.get("doublesArray");

        assertEquals(V8API.DOUBLE, doublesArray.getType());
        doublesArray.close();
    }
    ...
    public void testCreateArrayInvalidOffset_Int32Array() {
        ...
        try {
            new V8TypedArray(v8Context, buffer, V8API.INTEGER, 1, 2).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateArrayInvalidLength_Int32Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        try {
            new V8TypedArray(v8Context, buffer, V8API.INTEGER, 0, 3).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateArrayInvalidLengthNegative_Int32Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        try {
            new V8TypedArray(v8Context, buffer, V8API.INTEGER, 0, -1).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateArrayInvalidLengthWithOffset_Int32Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 12);
        try {
            new V8TypedArray(v8Context, buffer, V8API.INTEGER, 4, 3).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testGetArrayBuffer_Int32Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int32Array = new V8TypedArray(v8Context, buffer, V8API.INTEGER, 0, 2);
    ...
    public void testUseAccessedArrayBuffer_Int32Array() {
        V8TypedArray array = (V8TypedArray) v8Context.executeScript("\n"
    ...
    public void testUpdateInt32TypedArrayInJavaScript() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int32Array = new V8TypedArray(v8Context, buffer, V8API.INTEGER, 0, 2);
        v8Context.add("v8Int32Array", v8Int32Array);

        v8Context.executeVoidScript("v8Int32Array[0] = 7; v8Int32Array[1] = 9;");
    ...
    public void testAccessInt32TypedArrayInJavaScript() {
        ...
        assertEquals(4, v8Context.executeIntegerScript("v8Int32Array[0];"));
        assertEquals(8, v8Context.executeIntegerScript("v8Int32Array[1];"));
        buffer.close();
        v8Int32Array.close();
    }
    ...
    public void testInt32TypedArray_CustomLength() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int32Array = new V8TypedArray(v8Context, buffer, V8API.INTEGER, 0, 1);
        v8Context.add("v8Int32Array", v8Int32Array);
    ...
    public void testInt32TypedArray_CustomOffset() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int32Array = new V8TypedArray(v8Context, buffer, V8API.INTEGER, 4, 1);
        v8Context.add("v8Int32Array", v8Int32Array);
    ...
    public void testInt32TypedArray_TwinHasSameValues() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int32Array1 = new V8TypedArray(v8Context, buffer, V8API.INTEGER, 0, 2);
    ...
    public void testGetInt32TypedArray() {
        ...
        V8Array array = (V8Array) v8Context.executeScript("new Int32Array(buf);");

        assertTrue(array instanceof V8TypedArray);
        assertEquals(V8API.INTEGER, array.getType());
        array.close();
        buffer.close();
    }
    ...
    public void testCreateV8Int32ArrayFromJSArrayBuffer() {
        V8ArrayBuffer buffer = (V8ArrayBuffer) v8Context.executeScript(""
                + "var buffer = new ArrayBuffer(8)\n"
                + "var array = new Int32Array(buffer);\n"
                + "array[0] = 7; array[1] = 9;\n"
                + "buffer;");

        V8TypedArray array = new V8TypedArray(v8Context, buffer, V8API.INTEGER, 0, 2);
    ...
    public void testGetByteBuffer_Int8Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int8Array = new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 2);
    ...
    public void testCreateArrayInvalidLength_Int8Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        try {
            new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 9).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateArrayInvalidLengthNegative_Int8Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        try {
            new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, -1).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateArrayInvalidLengthWithOffset_Int8Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 12);
        try {
            new V8TypedArray(v8Context, buffer, V8API.BYTE, 4, 11).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateByteTypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 2);
    ...
    public void testCreateInt8TypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.INT_8_ARRAY, 0, 2);

        typedArray.add("0", 7);
        typedArray.add("1", 8);

        assertEquals(V8API.INT_8_ARRAY, typedArray.getType());
        assertEquals(7, buffer.get());
        assertEquals(8, buffer.get());
        buffer.close();
        typedArray.close();
    ...
    public void testCreateUInt8TypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.UNSIGNED_INT_8_ARRAY, 0, 2);

        typedArray.add("0", 7);
        typedArray.add("1", 8);

        assertEquals(V8API.UNSIGNED_INT_8_ARRAY, typedArray.getType());
        assertEquals(7, buffer.get());
        assertEquals(8, buffer.get());
        buffer.close();
        typedArray.close();
    ...
    public void testCreateUInt8ClampedTypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.UNSIGNED_INT_8_CLAMPED_ARRAY, 0, 2);

        typedArray.add("0", 7);
        typedArray.add("1", 270);

        assertEquals(V8API.UNSIGNED_INT_8_CLAMPED_ARRAY, typedArray.getType());
        assertEquals(7, buffer.get());
    ...
    public void testCreateInt16TypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.INT_16_ARRAY, 0, 2);

        typedArray.add("0", 7);
        typedArray.add("1", 8);

        assertEquals(V8API.INT_16_ARRAY, typedArray.getType());
    ...
    public void testCreateUInt16TypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.UNSIGNED_INT_16_ARRAY, 0, 2);

        typedArray.add("0", 7);
        typedArray.add("1", 8);

        assertEquals(V8API.UNSIGNED_INT_16_ARRAY, typedArray.getType());
        assertEquals(7, buffer.getShort());
        assertEquals(8, buffer.getShort());
        buffer.close();
        typedArray.close();
    ...
    public void testCreateInt32TypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.INT_32_ARRAY, 0, 2);

        typedArray.add("0", 7);
        typedArray.add("1", 8);

        assertEquals(V8API.INT_32_ARRAY, typedArray.getType());
        assertEquals(7, buffer.getInt());
        assertEquals(8, buffer.getInt());
        buffer.close();
        typedArray.close();
    ...
    public void testCreateUInt32TypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.UNSIGNED_INT_32_ARRAY, 0, 2);

        typedArray.add("0", 7);
        typedArray.add("1", 8);

        assertEquals(V8API.UNSIGNED_INT_32_ARRAY, typedArray.getType());
        assertEquals(7, buffer.getInt());
        assertEquals(8, buffer.getInt());
        buffer.close();
        typedArray.close();
    ...
    public void testCreateFloat32TypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.FLOAT_32_ARRAY, 0, 2);

        assertEquals(V8API.FLOAT_32_ARRAY, typedArray.getType());
        buffer.close();
        typedArray.close();
    }
    ...
    public void testCreateFloat64TypedArray() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.FLOAT_64_ARRAY, 0, 1);

        assertEquals(V8API.FLOAT_64_ARRAY, typedArray.getType());
        buffer.close();
        typedArray.close();
    }
    ...
    public void testUpdateInt8TypedArrayInJavaScript() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int8Array = new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 2);
        v8Context.add("v8Int8Array", v8Int8Array);

        v8Context.executeVoidScript("v8Int8Array[0] = 7; v8Int8Array[1] = 9;");
    ...
    public void testAccessInt8TypedArrayInJavaScript() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 2);
        V8TypedArray v8Int8Array = new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 2);
        v8Context.add("v8Int8Array", v8Int8Array);
        ...
        assertEquals(4, v8Context.executeIntegerScript("v8Int8Array[0];"));
        assertEquals(8, v8Context.executeIntegerScript("v8Int8Array[1];"));
        buffer.close();
        v8Int8Array.close();
    }
    ...
    public void testInt8TypedArray_CustomLength() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int8Array = new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 1);
    ...
    public void testInt8TypedArray_CustomOffset() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int8Array = new V8TypedArray(v8Context, buffer, V8API.BYTE, 1, 1);
    ...
    public void testFloat64TypedArray_addInJava() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 16);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.FLOAT_64_ARRAY, 0, 2);
    ...
    public void testInt32TypedArray_addInJava() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 12);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.INT_32_ARRAY, 0, 3);
    ...
    public void testInt16TypedArray_addInJava() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 6);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.INT_16_ARRAY, 0, 3);
    ...
    public void testInt8TypedArray_addInJava() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 3);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.INT_8_ARRAY, 0, 3);
    ...
    public void testUInt8TypedArray_addInJava() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray typedArray = new V8TypedArray(v8Context, buffer, V8API.UNSIGNED_INT_8_ARRAY, 0, 8);
    ...
    public void testUInt8ClampedTypedArray_addInJava() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 8);
        V8TypedArray v8Int8Array = new V8TypedArray(v8Context, buffer, V8API.UNSIGNED_INT_8_CLAMPED_ARRAY, 0, 8);
    ...
    public void testInt8TypedArray_Twin() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 4);
        V8TypedArray v8Int8Array = new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 4);
        V8Array twinArray = v8Int8Array.twin();

        assertTrue(twinArray instanceof V8TypedArray);
        assertEquals(V8API.BYTE, twinArray.getType());
    ...
    public void testInt8TypedArray_TwinHasSameValues() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 4);
        V8TypedArray v8Int8Array1 = new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 4);
    ...
    public void testGetInt8TypedArray() {
        ...
        V8Array array = (V8Array) v8Context.executeScript("new Int8Array(buf);");
    ...
    public void testCreateV8Int8ArrayFromJSArrayBuffer() {
        ...
        V8TypedArray array = new V8TypedArray(v8Context, buffer, V8API.BYTE, 0, 2);
    ...
    public void testCreateTypedArrayWithIllegalType_Boolean() {
        ...
        try {
            new V8TypedArray(v8Context, buffer, V8API.BOOLEAN, 0, 10).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateTypedArrayWithIllegalType_String() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 10);
        try {
            new V8TypedArray(v8Context, buffer, V8API.STRING, 0, 10).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateTypedArrayWithIllegalType_V8Array() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 10);
        try {
            new V8TypedArray(v8Context, buffer, V8API.V8_ARRAY, 0, 10).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateTypedArrayWithIllegalType_V8Object() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 10);
        try {
            new V8TypedArray(v8Context, buffer, V8API.V8_OBJECT, 0, 10).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateTypedArrayWithIllegalType_V8ArrayBuffer() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 10);
        try {
            new V8TypedArray(v8Context, buffer, V8API.V8_ARRAY_BUFFER, 0, 10).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateTypedArrayWithIllegalType_V8Function() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 10);
        try {
            new V8TypedArray(v8Context, buffer, V8API.V8_FUNCTION, 0, 10).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateTypedArrayWithIllegalType_Null() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 10);
        try {
            new V8TypedArray(v8Context, buffer, V8API.NULL, 0, 10).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testCreateTypedArrayWithIllegalType_Undefined() {
        V8ArrayBuffer buffer = new V8ArrayBuffer(v8Context, 10);
        try {
            new V8TypedArray(v8Context, buffer, V8API.UNDEFINED, 0, 10).close();
        } finally {
            buffer.close();
        }
    }
    ...
    public void testInt8ArrayIs1Byte() {
        assertEquals(1, V8TypedArray.getStructureSize(V8API.INT_8_ARRAY));
    }

    @Test
    public void testUInt8ArrayIs1Byte() {
        assertEquals(1, V8TypedArray.getStructureSize(V8API.UNSIGNED_INT_8_ARRAY));
    }

    @Test
    public void testUInt8ClampedArrayIs1Byte() {
        assertEquals(1, V8TypedArray.getStructureSize(V8API.UNSIGNED_INT_8_CLAMPED_ARRAY));
    }

    @Test
    public void testInt16ArrayIs2Bytes() {
        assertEquals(2, V8TypedArray.getStructureSize(V8API.INT_16_ARRAY));
    }

    @Test
    public void testUInt16ArrayIs2Bytes() {
        assertEquals(2, V8TypedArray.getStructureSize(V8API.UNSIGNED_INT_16_ARRAY));
    }

    @Test
    public void testInt32ArrayIs4Bytes() {
        assertEquals(4, V8TypedArray.getStructureSize(V8API.INT_32_ARRAY));
    }

    @Test
    public void testUInt32ArrayIs4Bytes() {
        assertEquals(4, V8TypedArray.getStructureSize(V8API.UNSIGNED_INT_32_ARRAY));
    }

    @Test
    public void testFloat32ArrayIs4Bytes() {
        assertEquals(4, V8TypedArray.getStructureSize(V8API.FLOAT_32_ARRAY));
    }

    @Test
    public void testFloat64ArrayIs8Bytes() {
        assertEquals(8, V8TypedArray.getStructureSize(V8API.FLOAT_64_ARRAY));
    }
